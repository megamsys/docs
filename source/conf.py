...
project = 'Megam'
copyright = '2014, Megam Team <gomegam@megam.co.in>'
...
# Github path
github_repo   = "https://github.com/megamsys/docs"
...
htmlhelp_basename = 'Megamdoc'


# -- Options for LaTeX output --------------------------------------------------

guide_main_title = "Megam %s " % (version,)
file_main_title  = "megam_%s_" % (version,)
latex_author     = "Megam Project"
...
man_pages = [
    ('index', 'Megam', 'Megam Documentation',
     ['Megam Team <gomegam@megam.co.in>'], 1)
]
...
texinfo_documents = [
  ('index', 'Megam', 'OpenNebula Documentation',
   'Megam Team <gomegam@megam.co.in>', 'Megam', 'Cloud In a Box, Cloud orchestration.',
   'Miscellaneous'),
]
