# -*- coding: utf-8 -*-
#
# Megam Cloud documentation build configuration file, created by
...
# of the sidebar.
html_logo = '_static/images/logo-megam160x43.png'
...
texinfo_documents = [
  ('index', 'MegamCloud', u'Megam Cloud Documentation',
   u'kishore(nkishore@megam.co.in), thomas(alrin@megam.co.in), raj(rajthilak@megam.co.in)', 'MegamCloud', 'One line description of project.',
   'Miscellaneous'),
]
